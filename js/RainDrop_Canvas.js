...
addEventListener("resize", function() {
    ...
    for (var i = 0; i < 150; i++) {
        ...
        gravity = (Math.random() - 0.5) * 0.25 ;
        // var friction = 0.95;
        color = randomColor(colors);

        x = (canvas.width/2 - radius * 2) + radius;
        y = (canvas.height/2 - radius * 2) + radius;
        ...
        if (circleArray.length > amount){
            circleArray.length=amount;
        }
    }
